...
function preload() {
	...
	grassBlock      = loadImage("grass101.png")
...
function setup() {
	...
	platfoarm1.addImage(grassBlock)
	platfoarm1.setCollider("rectangle",0,0,120,20)

	platfoarm2 = createSprite(300, 300, 200, 20);
	platfoarm2.shapeColor = "brown";
	platfoarm2.addImage(grassBlock)
	platfoarm2.setCollider("rectangle",0,0,120,20)

	platfoarm3 = createSprite(100, 200, 200, 20);
	platfoarm3.shapeColor = "brown";
	platfoarm3.addImage(grassBlock)
	platfoarm3.setCollider("rectangle",0,0,120,20)

	platfoarm4 = createSprite(600, 400, 200, 20);
	platfoarm4.shapeColor = "brown";
	platfoarm4.addImage(grassBlock)
	platfoarm4.setCollider("rectangle",0,0,120,20)
